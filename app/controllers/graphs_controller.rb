...
class GraphsController < ApplicationController
 ...
 def categoryview
	...
	@categories = Category.where("month_name = ?",Category.get_month_name).select("categorytype, SUM(expense) ").group("categorytype")
  ...
  def categorydateview
	...
	@dates.each do |d|
		...
		@categories = Category.where("categorytype= ? and date_spent = ?",c.categorytype,d.date_spent).select(" categorytype, sum(expense)").Group("categorytype")
		@categories.each do |category|
